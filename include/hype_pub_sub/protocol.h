...
int hype_pub_sub_protocol_send_info_msg(Protocol* protocol, byte dest_network_id[HYPE_CONSTANTS_ID_BYTE_SIZE], char* msg, size_t msg_length);

int hype_pub_sub_protocol_receive_msg(Protocol* protocol, byte origin_network_id[HYPE_CONSTANTS_ID_BYTE_SIZE]);
