...
void hpb_list_service_managers_test()
{
    ...
    CU_ASSERT(hpb_list_service_managers_find(serv_managers, SERVICE_KEY1) != NULL);
    CU_ASSERT(hpb_list_service_managers_find(serv_managers, SERVICE_KEY2) != NULL);
    CU_ASSERT(hpb_list_service_managers_find(serv_managers, SERVICE_KEY3) != NULL);
    byte NEW_KEY[] = "\x86\xc9\xb3\x10\\x77\x24\x62\xc4xa6\x90\x91\x64\xf5\x5e\xf6\x5a\x65\xd5\x91\x31";
    CU_ASSERT(hpb_list_service_managers_find(serv_managers, NEW_KEY) == NULL);
