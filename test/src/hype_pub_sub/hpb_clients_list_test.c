...
void hpb_list_clients_test()
{
    ...
    HypeBuffer *non_existent_client_buffer_id = hype_buffer_create_from(NON_EXISTENT_CLIENT_HYPE_ID, CLIENT_HYPE_ID_SIZE);
    ...
    HypeInstance *non_existent_instance = hype_instance_create(non_existent_client_buffer_id, NULL, false);
    ...
    CU_ASSERT_NSTRING_EQUAL(aux_cl->hype_instance->identifier->data, CLIENT3_HYPE_ID, CLIENT_HYPE_ID_SIZE);
    linked_list_iterator_advance(it);
    aux_cl = (HpbClient *) linked_list_iterator_get_element(it);
    CU_ASSERT_NSTRING_EQUAL(aux_cl->hype_instance->identifier->data, CLIENT2_HYPE_ID, CLIENT_HYPE_ID_SIZE);
    linked_list_iterator_advance(it);
    aux_cl = (HpbClient *) linked_list_iterator_get_element(it);
    CU_ASSERT_NSTRING_EQUAL(aux_cl->hype_instance->identifier->data, CLIENT4_HYPE_ID, CLIENT_HYPE_ID_SIZE);
    linked_list_iterator_advance(it);
    aux_cl = (HpbClient *) linked_list_iterator_get_element(it);
    CU_ASSERT_NSTRING_EQUAL(aux_cl->hype_instance->identifier->data, CLIENT1_HYPE_ID, CLIENT_HYPE_ID_SIZE);
    ...
    hype_buffer_release(non_existent_client_buffer_id);
}
