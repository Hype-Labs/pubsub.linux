...
void hype_pub_sub_service_manager_test()
{
    ...
    ServiceManager *serv1 = hype_pub_sub_service_manager_create(SERVICE1_KEY);
    ServiceManager *serv2 = hype_pub_sub_service_manager_create(SERVICE2_KEY);
    ...
    hype_pub_sub_service_manager_destroy(&serv1);
    hype_pub_sub_service_manager_destroy(&serv2);
