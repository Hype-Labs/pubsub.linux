...
int hpb_list_service_managers_remove(ListServiceManagers *list_serv_man, HLByte service_key[])
{
...
HpbServiceManager *hpb_list_service_managers_find(ListServiceManagers *list_serv_man, HLByte service_key[])
{
