...
int hype_pub_sub_protocol_send_subscribe_msg(char service_key[], char dest_network_id[])
{
    return 0;
}

int hype_pub_sub_protocol_send_unsubscribe_msg(char service_key[], char dest_network_id[])
{
    return 0;
}

int hype_pub_sub_protocol_send_publish_msg(char service_key[], char dest_network_id[], char *msg)
{
    return 0;
}

int hype_pub_sub_protocol_send_change_service_manager_msg(char service_key[], char dest_network_id[], char **subscribers_ids[])
{
    return 0;
}

int hype_pub_sub_protocol_send_info_msg(ProtocolManager *protocol, char dest_network_id[], char *string)
{
    return 0;
}

int hype_pub_sub_protocol_receive_msg(ProtocolManager *protocol, char origin_network_id[])
{
    return 0;
}
